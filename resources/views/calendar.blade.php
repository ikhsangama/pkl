...
<html>
    <head>
        ...
        <!--calendar css-->
        <link rel="stylesheet" href="{{ URL::asset('assets/plugins/fullcalendar/dist/fullcalendar.css') }}" />
        ...
        <link rel="stylesheet" href="{{ URL::asset('assets/css/pages.css') }}" />
    ...
    <body class="fixed-left">
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="calendar.html" class="waves-effect active"><i class="zmdi zmdi-calendar"></i><span> Calendar </span></a>
                            </li>
        ...
        <script src="{{ URL::asset('assets/plugins/fullcalendar/dist/fullcalendar.min.js') }}"></script>
        <script src="{{ URL::asset('assets/pages/jquery.fullcalendar.js') }}"></script>
